...
\begin{enumerate}[start = 1, label = {\bfseries Question \arabic*:}, leftmargin=1in, itemsep=1.5em]
    ...
    \item \begin{itemize}
        ...
        \end{proof}
        \item[(b)] \begin{proof}
            It is not necessarily true. We prove this by a counterexample: consider $f: \mathbb{R} \to \mathbb{R}$ given by $f(x)=2^x$, and $g: \mathbb{R} \to \mathbb{R}$ given by $g(x) = x^2$. $f$ is not surjective, because the negative reals are never accessed. $g$ is not injective because $g(1)=g(-1)=1$. However, $g\circ f = {(2^x)}^2 = 4^x$, which is injective.
        \end{proof}
    \end{itemize}
    \item
        \begin{proof}
